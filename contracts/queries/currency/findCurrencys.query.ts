...
export namespace FindCurrencysQuery {
  /*** The channel that need to listen. between `Preload` and `Window` */
  export const channel: ChannelCurrency = 'find_currencys';

  /*** These values must be send from `Client app` to `Electron app`.*/
  export class Request implements Prisma.CurrencyWhereInput {
    id?: number | Prisma.IntFilter<'Currency'> | undefined;
    name?: string | Prisma.StringFilter<'Currency'> | undefined;
    shortName?: string | Prisma.StringFilter<'Currency'> | undefined;
  ...
  export const where = ({ id, name, shortName, AND, NOT, OR }: Request): Prisma.CurrencyFindManyArgs['where'] => {
    const payload: Prisma.CurrencyFindManyArgs['where'] = {};
