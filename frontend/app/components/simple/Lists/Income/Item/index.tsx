...
import { DrawerUpdateIncome } from '../DrawerUpdateIncome';

export const ItemIncome: React.FC<ItemProps> = ({ income }): JSX.Element => {
  const dataFns = new DateFns();
  const { description, value, isRefund, createAt, refundAt, currencyName } = income;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Divider />
        <Flex>
          <DrawerUpdateIncome income={income} />
        </Flex>
      </AccordionPanel>
    </AccordionItem>
  );
